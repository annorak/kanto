...
from kanto_common.config import ObjectStorageSettings
...
class ObjectStorage(Protocol):
    ...
    :mod:`kanto_common.testing` also implements it. Services can take
...
class ObjectStorageClient:
    ...
    use ``FakeObjectStorage`` from :mod:`kanto_common.testing`.
    """
