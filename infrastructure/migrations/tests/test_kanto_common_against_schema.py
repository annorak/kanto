"""Run every kanto-common Mew repository method against the migrated schema.
...
The kanto-common package has its own integration tests that exercise
the same surface area; the duplication here is intentional. Those
tests live next to the client code (so kanto-common contributors run
